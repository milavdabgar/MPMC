...
### Example 11-2 Write a program that continuously get 8-bit data from P0 and sends it to P1 while simultaneously creating a square wave of 200 �s period on pin P2.1. Use timer 0 to create the square wave. Assume that XTAL = 11.0592 MHz.
